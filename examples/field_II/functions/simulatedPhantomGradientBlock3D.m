function [sca,amp] = simulatedPhantomGradientBlock3D(sca_per_mm2,x_min,x_max,z_min,z_max,y_min,y_max,Intensity,dB_mm)
...
yyp_speckle=random('unif',y_min,y_max,N,1);
...
sca = [xxp_speckle yyp_speckle zzp_speckle];   % list with the scatterers coordinates [m]
